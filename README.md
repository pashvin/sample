...
This project also shows three different (D3, Chart.js, Google) chart library usage. Nowadays, there are many projects where we show data graphically and these libraries are very useful.
